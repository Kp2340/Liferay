 ...
 * <code>com.example.college.service.impl.StudentLocalServiceImpl</code> and
...
public class StudentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.example.college.service.impl.StudentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static Student addStudent(String name, String branch, int year) {
		return getService().addStudent(name, branch, year);
	}
	...
	public static Student updateStudent(
		...
		return getService().updateStudent(studentId, name, branch, year);
	}
