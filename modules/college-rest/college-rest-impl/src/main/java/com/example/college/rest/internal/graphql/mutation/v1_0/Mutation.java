package com.example.college.rest.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	public Student createStudent(@GraphQLName("student") Student student)
		...
		return _applyComponentServiceObjects(
			...
			studentResource -> studentResource.postStudent(student));
	}

	@GraphQLField
	public Response createStudentBatch(
		...
		return _applyComponentServiceObjects(
			_studentResourceComponentServiceObjects,
			this::_populateResourceContext,
			studentResource -> studentResource.postStudentBatch(
				callbackURL, object));
	}

	@GraphQLField
	public Response deleteStudent(@GraphQLName("studentId") Long studentId)
		throws Exception {

		return _applyComponentServiceObjects(
			_studentResourceComponentServiceObjects,
			this::_populateResourceContext,
			studentResource -> studentResource.deleteStudent(studentId));
	}
	...
	public Student updateStudent(
			@GraphQLName("studentId") Long studentId,
			@GraphQLName("student") Student student)
		throws Exception {

		return _applyComponentServiceObjects(
			_studentResourceComponentServiceObjects,
			this::_populateResourceContext,
			studentResource -> studentResource.putStudent(studentId, student));
	}

	@GraphQLField
	public Response updateStudentBatch(
			@GraphQLName("callbackURL") String callbackURL,
			@GraphQLName("object") Object object)
		throws Exception {
		...
		return _applyComponentServiceObjects(
			_studentResourceComponentServiceObjects,
			this::_populateResourceContext,
			studentResource -> studentResource.putStudentBatch(
				callbackURL, object));
	}
