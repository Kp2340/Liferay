package com.example.college.rest.resource.v1_0.test;

import com.example.college.rest.client.dto.v1_0.Student;
import com.example.college.rest.client.http.HttpInvoker;
import com.example.college.rest.client.pagination.Page;
import com.example.college.rest.client.resource.v1_0.StudentResource;
...
public abstract class BaseStudentResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		Assert.assertEquals(regex, student.getBranch());
	...
	public void testPostStudent() throws Exception {
		...
		Student postStudent = testPostStudent_addStudent(randomStudent);

		assertEquals(randomStudent, postStudent);
		assertValid(postStudent);
	}

	protected Student testPostStudent_addStudent(Student student)
		throws Exception {
	...
	protected void assertValid(
		Page<Student> page, Map<String, Map<String, String>> expectedActions) {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.example.college.rest.dto.v1_0.Student.class)) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("branch", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						student1.getBranch(), student2.getBranch())) {
			...
			if (Objects.equals("year", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						student1.getYear(), student2.getYear())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("branch")) {
			Object object = student.getBranch();
		...
		if (entityFieldName.equals("year")) {
			sb.append(String.valueOf(student.getYear()));
	...
	@Inject
	private com.example.college.rest.resource.v1_0.StudentResource
		_studentResource;
